                        ...
                        <div className="col-xs-6">
                            <form onSubmit={this.onHandleSubmit}>
                                <div className="form-group">
                                    ...
                                    <input type="number" className="form-control" name="inventoryNumber" defaultValue={inventoryNumber} onChange={this.onChange} min="1" max="999" required/>
                                    <label>Giá bán : </label>
                                    <input type="number" className="form-control" name="price" defaultValue={price} onChange={this.onChange} min="1" max="999999999" required/>
